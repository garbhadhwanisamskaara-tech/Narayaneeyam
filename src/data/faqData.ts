export const faqSections = [
  ...
  },
  {
    ...
    questions: [
      { q: "How does the Chant feature work?", a: "Think of this as your digital prayer companion. The app displays the text on screen when the audio is played, helping you maintain the correct rhythm, meter, tune and speed — which is crucial for traditional Narayaneeyam recitation." },
      { q: "Can I chant at my own pace?", a: "Yes — use the speed control (0.5x, 1x, 1.5x, 2x) to slow down or speed up the audio to match your comfort level." },
      { q: "What is the Loop feature?", a: "Loop repeats a shloka or dashakam automatically so you can practice chanting without manually replaying." },
  ...
  },
  {
    ...
    questions: [
      { q: "What is the Podcast section?", a: "The Podcast features full audio episodes on each Dashakam — ideal for listening during commute, walks, or daily routines." },
      { q: "Can I use the app while commuting or working?", a: "Absolutely. The Podcast mode lets you play entire Dashakams in the background, allowing the healing vibrations of Narayaneeyam to fill your environment even when you are not looking at the screen." },
      { q: "Can I listen offline?", a: "Currently the app requires an internet connection. Offline support may be added in a future update." },
      { q: "How long is each podcast episode?", a: "Duration depends on the dashakam you choose, the loop setting, and the playback speed." },
    ],
  },
  {
    heading: "Progress and Account",
    questions: [
      { q: "Can I track my progress?", a: "Yes. Learning 100 Dashakams is a journey. Once logged in, the app tracks which dashakams you have chanted and learned, and allows you to mark verses as Mastered or In Progress — so you can pick up exactly where you left off." },
      { q: "Can I create a custom playlist?", a: "Yes — you can create playlists of your favourite shlokas or dashakams for a personalised chanting session." },
      { q: "Is my data private and secure?", a: "Yes — your account data and chanting recordings are stored securely and are only accessible to you." },
    ],
  },
  {
    heading: "Support",
    questions: [
      { q: "Who can I contact for support or feedback?", a: "You can reach us through the Support section in the app menu. We welcome all feedback to help improve the experience for devotees worldwide." },
    ],
  },
];
