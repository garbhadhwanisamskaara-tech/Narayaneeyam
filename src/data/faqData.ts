...
export const faqSections = [
  ...
  },
  {
    ...
    questions: [
      { q: "How does the Chant feature work?", a: "Choose a Dashakam, press play, and the verse text is highlighted line by line as the audio plays — helping you hold the correct rhythm, metre, tune and speed that traditional Narayaneeyam recitation asks for." },
      { q: "Can I chant at my own pace?", a: "Yes — the speed control offers 0.6×, 0.75×, 1×, 1.25× and 1.5×, so you can slow the recitation down while learning and return to normal speed when you are ready." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "I cannot see my Bloom Garden", a: "Bloom Garden only appears for group parayanams — check that you are actually part of a group parayanam first. If you are, go to the bell icon and select 'Update your Bloom Garden' after completing a dashakam; it does not always update automatically. If you still cannot see it after that, please raise a ticket." },
      { q: "What is the bell icon for?", a: "The bell icon is your notification center. It shows: parayanam invites waiting for you to confirm or decline, any pending payment needed to join a parayanam, replies to your support tickets (tap 'Open ticket' to view the full reply), your upcoming dashakam queue, and — if you are part of a group parayanam — a shortcut to update your own Bloom Garden after completing a dashakam. The consolidated Bloom Garden showing everyone's combined progress is visible only to the group owner." },
